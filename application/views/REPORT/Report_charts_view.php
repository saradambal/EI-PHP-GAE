...
// initial data
    ...
    $.ajax({
        type: "POST",
        url: "<?php echo site_url('Report_charts_controller/Initialdata'); ?>",
...
// sp input and response
    function CHART_func_expense_inputdata(unitno,fromdate,todate,srch_data,flag){
        ...
        $.ajax({
            type: "POST",
            url: "<?php echo site_url('Report_charts_controller/Expense_inputdata'); ?>",
...
// change event for chart name
    ...
    $(document).on('change','#chart_lb_name',function(){
        ...
        if(nameval!='SELECT'){
            ...
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('Report_charts_controller/Subchartdata'); ?>",
