...
<!--UPDATE FORM FUNCTIONS   -->
  ...
  //LIST BOX ITEM CHANGE FUNCTION
            $('#PE_lb_selectform').change(function(){
            ...
            if(listboxoption=='entryform')
            {
                ...
                $.ajax({
                type: "POST",
                url: "<?php echo base_url(); ?>" + "index.php/Expense_personal_daily_entry_controller/commondata",
...
//CAR EXPENSE SAVE FUNCTION
            $('#PCE_save_btn').click(function(){
                ...
                $.ajax({
                    ...
                    url: "<?php echo base_url(); ?>" + "index.php/Expense_personal_daily_entry_controller/carexpensesave",
                    success: function(res) {
                        $('.preloader').hide();
                        if(res==1)
                        {
...
// CAR LOAN SAVE FUNCTION
            $('#PCLE_save_btn').click(function(){
                ...
                $.ajax({
                    type: "POST",
                    data: $('#personalexpense').serialize(),
                    url: "<?php echo base_url(); ?>" + "index.php/Expense_personal_daily_entry_controller/carloansave",
                    success: function(res) {
                        $('.preloader').hide();
                        if(res==1)
                        {
...
//EXPENSE BABY AND PERSONAL SAVE FUNCTION
            $('#PDLY_INPUT_btn_bbypsnlsbutton').click(function(){
                ...
                $.ajax({
                    type: "POST",
                    data: $('#personalexpense').serialize(),
                    url: "<?php echo base_url(); ?>" + "index.php/Expense_personal_daily_entry_controller/babypersonalsave",
                    success: function(res) {
                        $('.preloader').hide();
...
//            $('#PDLY_SEARCH_div_htmltable').css('height',px)
            ...
            $(document).on('change','.babyupdate', function (){
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>" + "index.php/Expense_personal_daily_entry_search_update_delete_controller/expensebabyupdate",
            ...
            $(document).on('change','.carupdate', function (){
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>" + "index.php/Expense_personal_daily_entry_search_update_delete_controller/expensecarupdate",
            ...
            $(document).on('change','.personalupdate', function (){
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>" + "index.php/Expense_personal_daily_entry_search_update_delete_controller/expensepersonalupdate",
            ...
            $(document).on('change','.carloanupdate', function (){
                ...
                //CHECK PAID DATE GREATER THAN FROM PERIOD & TO PERIOD
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url(); ?>" + "index.php/Expense_personal_daily_entry_search_update_delete_controller/expensecarloanupdate",
            ...
            $(document).on('click','.PDLY_SEARCH_btn_deletebutton',function(){
                ...
                show_msgbox("PERSONAL EXPENSE ENTRY/SEARCH/UPDATE/DELETE",PDLY_SEARCH_hdrmsgArray[35].EMC_DATA,"success",true);
            });
            $(document).on('click','.menuconfirm',function(){
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo base_url(); ?>" + "index.php/Expense_personal_daily_entry_search_update_delete_controller/deleteoption",
                    data:'&PDLY_SEARCH_lb_typelistvalue='+PDLY_SEARCH_lb_typelistvalue+'&PDLY_rowid='+PDLY_rowid+'&startdate='+$('#PDLY_SEARCH_db_startdate').val()+'&enddate='+$('#PDLY_SEARCH_db_enddate').val()+'&PDLY_SEARCH_lb_babysearchoptionvalue='+$('#PDLY_SEARCH_lb_babysearchoption').val(),
                    success: function(data) {
                        $('.preloader').hide();
...
<form id="personalexpense" class="form-horizontal content">
            ...
            <div class="panel-body">
                <div class="form-group">
                    <label id="PE_lbl_selectform" class="col-sm-2" >LIST BOX OPTIONS<em>*</em></label>
                    <div class="col-sm-2">
                        <select id='PE_lb_selectform' name="PE_lb_selectform"  class="form-control" >
