...
<head>
    ...
    // document ready function
        ...
        // initial data
            $.ajax({
                type: "POST",
                url: "<?php echo site_url('Ctrl_Extract_Deposit_Pdf/Initialdata'); ?>",
        ...
        // CHANGE FUNCTION FOR MONTH SELECTION
            $('#DDE_lb_monthselect').change(function(){
                ...
                else
                {
                    $.ajax({
                        type: "POST",
                        url: "<?php echo site_url('Ctrl_Extract_Deposit_Pdf/DDE_getsheetunit'); ?>",
                        data: {'month':month},
        ...
        // SHOWS THE CUSTOMER LISTBOX..................
            $('#DDE_lb_unitselect').change(function(){
                ...
                else
                {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "<?php echo site_url('Ctrl_Extract_Deposit_Pdf/DDE_customername'); ?>",
            ...
            $('#DDE_lb_customerselect').change(function(){
                ...
                else
                {
                    ...
                    if(DDE_flag_radio_custname==0){
                        ...
                        $.ajax({
                            type: "POST",
                            url: "<?php echo site_url('Ctrl_Extract_Deposit_Pdf/DDE_getcustid'); ?>",
        ...
        // CLICK FUNCTION FOR RADIO BTN FOR DUPLICATE CUSTOMER
            $(document).on('click','.DDE_class_customeridname',function(){
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('Ctrl_Extract_Deposit_Pdf/DDE_Dep_Exct_recversionfun'); ?>",
        ...
        // CONFORMATION MESSAGE IS  SHOWS AFTER CLICK THE SUBMIT BUTTON................
            $('#DDE_btn_sbutton').click(function(){
                ...
                $.ajax({
                    type: "POST",
                    url: "<?php echo site_url('Ctrl_Extract_Deposit_Pdf/DDE_Dep_Exct_submit'); ?>",
                    data: formelement,
