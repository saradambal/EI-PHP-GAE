...
<script>
    $(document).ready(function(){
        ...
        $.ajax({
            type: "POST",
            url: '/index.php/Ctrl_Model_Forms/Model_initialdatas',
     ...
     var ifcondition;
        ...
        $(document).on('change','.ModelUpdate',function() {
            ...
            if(flag==0)
            {
                $.ajax({
                    type: "POST",
                    url: '/index.php/Ctrl_Model_Forms/ModelnameUpdate',
                    data:data,
                    success: function(data){
        ...
        $(document).on('click','.Model_removebutton',function() {
            ...
            $.ajax({
                type: "POST",
                url: '/index.php/Ctrl_Model_Forms/ModelnameDelete',
                data:{Data:Rowid},
                success: function(data){
                    var value_array=JSON.parse(data);
        ...
        $(document).on('click','#AddModelname',function() {
            ...
            $.ajax({
                type: "POST",
                url: '/index.php/Ctrl_Model_Forms/ModelnameInsert',
                data:{Data:modelname},
                success: function(data){
