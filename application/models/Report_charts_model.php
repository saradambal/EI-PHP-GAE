<?php
class Report_charts_model extends CI_Model {
    public function Initial_data()
    {
        ...
        $this->db->where('EMC_ID IN (387,388,389,390,391,392,393,394)');
        $query = $this->db->get();
    ...
    public function Expense_input_data($unitno,$fromdate,$todate,$srch_data,$flag){
