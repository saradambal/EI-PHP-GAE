<?php
error_reporting(0);
class Mdl_customersearch extends CI_Model
{
    ...
    public function Customer_Search_Update($UserStamp,$Leaseperiod,$Quoters)
    {
        ...
        $CheckOutCleanFee=$_POST['CCRE_SRC_CheckOutCleanFee'];
        $DepositFee=$_POST['CCRE_SRC_DepositFee'];
        $Rent=$_POST['CCRE_SRC_Rent'];
        $ProcessingFee=$_POST['CCRE_SRC_ProcessingFee'];
