<?php
Class Mdl_biz_expense_detail_entry_search_update_delete extends CI_Model {
    ...
    $BDTL_INPUT_biz_detail_error_array=$this->Mdl_eilib_common_function->GetErrorMessageList('1,2,103,105,238,248,400,458');
    ...
    {
        $this->load->model('EILIB/Mdl_eilib_common_function');
        $BDTL_INPUT_getDate=$this->Mdl_eilib_common_function->GetUnitSdEdate($BDTL_INPUT_unitno);
    ...
    public function BDTL_INPUT_airconservicedby_check($BDTL_INPUT_alreadyexists)
    {
      ...
      $this->load->model('EILIB/Mdl_eilib_common_function');
      $BDTL_INPUT_flag=$this->Mdl_eilib_common_function->Check_ExistsAirconservicedby($BDTL_INPUT_alreadyexists);
    ...
    public function BDTL_INPUT_save($USERSTAMP,$BDTL_INPUT_tb_newaircon,$calid)
     {
      ...
      else if($BDTL_INPUT_expensetypes==14)
      {
        ...
        /*-------------------------------CREATING CALENDAR EVENT FUNCTION FOR STARHUB------------------------*/
          ...
          $BDTL_INPUT_sh_arr=$this->Mdl_eilib_common_function->getStarHubUnitCalTime();
...
//                $this->Mdl_eilib_calender->StarHubUnit_DeleteCalEvent($calid,$BTDTL_SEARCH_cablesdate,$BTDTL_SEARCH_sh_starttime,$BTDTL_SEARCH_sh_endtime,$BTDTL_SEARCH_cableedate,$BTDTL_SEARCH_sh_starttime,$BTDTL_SEARCH_sh_endtime,'STARHUB',$unitno,$acctno,'CABLE START DATE','CABLE END DATE','','');
//            }
...
//                $this->Mdl_eilib_calender->StarHubUnit_DeleteCalEvent($calid,$BTDTL_SEARCH_internetsdate,$BTDTL_SEARCH_sh_starttime,$BTDTL_SEARCH_sh_endtime,$BTDTL_SEARCH_internetedate,$BTDTL_SEARCH_sh_starttime,$BTDTL_SEARCH_sh_endtime,'STARHUB',$unitno,$acctno,'INTERNET START DATE','INTERNET END DATE','','');
//            }
