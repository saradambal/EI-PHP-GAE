<?php
class Ctrl_Biz_Expense_Daily_Entry_Search_Update_Delete extends CI_Controller{
    function __construct() {
        parent::__construct();
        $this->load->model('EXPENSE/BIZEXPENSE/Mdl_biz_expense_daily_entry_search_update_delete');
        $this->load->model('EILIB/Mdl_eilib_common_function');
    }
// initial form
    public function index()
    {
        $this->load->view('EXPENSE/BIZEXPENSE/Vw_Biz_Expense_Daily_Entry_Search_Update_Delete');
    }
    public function initialvalues()
    {
        ...
        $this->load->database();
        $data=$this->Mdl_biz_expense_daily_entry_search_update_delete->initialvalues($ErrorMessage);
    ...
    public function BDLY_INPUT_checkexistunit()
    {
        ...
        $this->load->database();        
        $data=$this->Mdl_biz_expense_daily_entry_search_update_delete->BDLY_INPUT_checkexistunit($BDLY_INPUT_unitval);
        echo $data;
    }
    public function BDLY_INPUT_get_unitno()
    {
        ...
        $this->load->database();        
        $data=$this->Mdl_biz_expense_daily_entry_search_update_delete->BDLY_INPUT_get_unitno($BDLY_INPUT_type);
        echo json_encode($data);
    }
    public function BDLY_INPUT_get_balance()
    {
        $this->load->database();        
        $data=$this->Mdl_biz_expense_daily_entry_search_update_delete->BDLY_INPUT_get_balance();
        echo json_encode($data);
    }
    public function BDLY_INPUT_get_cleanername()
    {
        $this->load->database();        
        $data=$this->Mdl_biz_expense_daily_entry_search_update_delete->BDLY_INPUT_get_cleanername();
        echo json_encode($data);
    }
    public function BDLY_INPUT_get_allunitno()
    {
        $this->load->database();        
        $data=$this->Mdl_biz_expense_daily_entry_search_update_delete->BDLY_INPUT_get_allunitno();
        echo json_encode($data);
    }
    public function BDLY_INPUT_get_SEdate()
    {
        ...
        $this->load->database();        
        $data=$this->Mdl_eilib_common_function->GetUnitSdEdInvdate($BDLY_INPUT_unitno);
        echo json_encode($data);
    }
    public function BDLY_INPUT_get_values()
    {
        ...
        $BDLY_INPUT_type=$this->input->post('BDLY_INPUT_type');
        $this->load->database();        
        $data=$this->Mdl_biz_expense_daily_entry_search_update_delete->BDLY_INPUT_get_values($BDLY_INPUT_unitno,$BDLY_INPUT_type);
        echo json_encode($data);
    }
    public function BDLY_INPUT_get_invoiceto()
    {
        ...
        $this->load->database();        
        $data=$this->Mdl_biz_expense_daily_entry_search_update_delete->BDLY_INPUT_get_invoiceto($BDLY_INPUT_unit);
        echo json_encode($data);
    }
    public function BDLY_INPUT_save_values()
    {
        ...
        $this->load->database();        
        $data=$this->Mdl_biz_expense_daily_entry_search_update_delete->BDLY_INPUT_save_values($USERSTAMP);
        echo json_encode($data);
    }
    public function BDLY_INPUT_checkcardno()
    {
        ...
        $data=$this->Mdl_biz_expense_daily_entry_search_update_delete->BDLY_INPUT_checkcardno($BDLY_INPUT_cardno);
        echo $data;
    }
    public function BDLY_INPUT_get_category()
    {
        ...
        $data=$this->Mdl_biz_expense_daily_entry_search_update_delete->BDLY_INPUT_get_category($BDLY_INPUT_uexp_unit);
        echo json_encode($data);
    }
    public function BDLY_INPUT_get_accno()
    {
        ...
        $data=$this->Mdl_biz_expense_daily_entry_search_update_delete->BDLY_INPUT_get_accno($BDLY_INPUT_star_unitt);
        echo json_encode($data);
    }
 ...
 //SEARCH AND UPDATE FORM
    public function BDLY_SRC_getInitialvalue()    {
        ...
        $this->load->database();        
        $data=$this->Mdl_biz_expense_daily_entry_search_update_delete->BDLY_SRC_getInitialvalue();
        echo json_encode($data);
    }
      ...
      public function BDLY_SRC_getSearchOptions()
      {
          ...
          $data=$this->Mdl_biz_expense_daily_entry_search_update_delete->BDLY_SRC_getSearchOptions($selectedexpense,$USERSTAMP);
          echo json_encode($data)  ;
      }
    ...
    public  function  BDLY_SRC_get_cleanernameservicedue(){
        ...
        $data=$this->Mdl_biz_expense_daily_entry_search_update_delete->BDLY_SRC_get_cleanername($BDLY_SRC_servicedue,$BDLY_SRC_servicedue,$selectedSearchopt);
        echo json_encode($data)  ;
    }
    public function BDLY_SRC_get_cusname(){
        ...
        $data=$this->Mdl_biz_expense_daily_entry_search_update_delete->BDLY_SRC_get_cusname(null,$startdate,$enddate);
        echo json_encode($data)  ;
    }
    public function BDLY_SRC_get_cusname1(){
        $this->load->database();
        $BDLY_DT_getunit_no=$this->input->post('BDLY_DT_getunit_no');        
        $data=$this->Mdl_biz_expense_daily_entry_search_update_delete->BDLY_SRC_get_cusname($BDLY_DT_getunit_no,"","");
        echo json_encode($data)  ;
    }
    ...
    public function BDLY_SRC_get_autocomplete()
    {
        $USERSTAMP= $this->Mdl_eilib_common_function->getSessionUserStamp();
        $this->load->database();        
        $data=$this->Mdl_biz_expense_daily_entry_search_update_delete->BDLY_SRC_get_autocomplete($USERSTAMP);
        echo json_encode($data)  ;
    }
    public function BDLY_SRC_getUnitexp_catg()
    {
        ...
        $startdate=$this->input->post('startdate');
        $enddate=$this->input->post('enddate');        
        $data=$this->Mdl_biz_expense_daily_entry_search_update_delete->BDLY_SRC_getUnitexp_catg($startdate,$enddate,0);
        echo json_encode($data)  ;
    }
    public function BDLY_SRC_get_accountno()
    {
        ...
        $enddate=$this->input->post('enddate');
        $selectedexpense=$this->input->post('selectedexpense');        
        $data=$this->Mdl_biz_expense_daily_entry_search_update_delete->BDLY_SRC_get_accountno($selectedexpense,$startdate,$enddate);
        echo json_encode($data)  ;
    }
    public function BDLY_SRC_invoiceto()
    {
        ...
        $selectedexpense=$this->input->post('selectedexpense');
        $selectedSearchopt=$this->input->post('selectedSearchopt');        
        $data=$this->Mdl_biz_expense_daily_entry_search_update_delete->BDLY_SRC_invoiceto($selectedexpense,$selectedSearchopt,$startdate,$enddate);
        echo json_encode($data)  ;
    }
    public  function  BDLY_SRC_get_cleanername(){
        ...
        $enddate=$this->input->post('enddate');
        $selectedSearchopt=$this->input->post('selectedSearchopt');        
        $data=$this->Mdl_biz_expense_daily_entry_search_update_delete->BDLY_SRC_get_cleanername($startdate,$enddate,$selectedSearchopt);
        echo json_encode($data)  ;
    }
    public  function  BDLY_SRC_getPurchase_card(){
        ...
        $startdate=$this->input->post('startdate');
        $enddate=$this->input->post('enddate');        
        $data=$this->Mdl_biz_expense_daily_entry_search_update_delete->BDLY_SRC_getPurchase_card($startdate,$enddate);
        echo json_encode($data)  ;
    }
    public  function  BDLY_SRC_getCarNoList(){
        ...
        $startdate=$this->input->post('startdate');
        $enddate=$this->input->post('enddate');        
        $data=$this->Mdl_biz_expense_daily_entry_search_update_delete->BDLY_SRC_getCarNoList($startdate,$enddate);
        echo json_encode($data)  ;
    }
    public  function  BDLY_SRC_getServiceByList(){
        ...
        $startdate=$this->input->post('startdate');
        $enddate=$this->input->post('enddate');        
        $data=$this->Mdl_biz_expense_daily_entry_search_update_delete->BDLY_SRC_getServiceByList($startdate,$enddate);
        echo json_encode($data)  ;
    }
    public  function  BDLY_SRC_getUnitList(){
        ...
        $selectedexpense=$this->input->post('selectedexpense');
        $selectedSearchopt=$this->input->post('selectedSearchopt');        
        $data=$this->Mdl_biz_expense_daily_entry_search_update_delete->BDLY_SRC_getUnitList($selectedexpense,$selectedSearchopt,$startdate,$enddate,$USERSTAMP);
        echo json_encode($data)  ;
    }
    public  function  BDLY_SRC_getDigitalVoiceNo(){
        ...
        $startdate=$this->input->post('startdate');
        $enddate=$this->input->post('enddate');        
        $data=$this->Mdl_biz_expense_daily_entry_search_update_delete->BDLY_SRC_getDigitalVoiceNo($startdate,$enddate);
        echo json_encode($data)  ;
    }
    public function BDLY_SRC_check_access_cardOrUnitno(){
        ...
        $data=$this->Mdl_biz_expense_daily_entry_search_update_delete->BDLY_SRC_check_access_cardOrUnitno($inputval,$BDLY_SRC_selectedexptype);
        echo json_encode($data)  ;
    }
    public function BDLY_SRC_getUnitDate(){
        $this->load->database();
        $unidate=$this->input->post('unidate');        
        $data=$this->Mdl_biz_expense_daily_entry_search_update_delete->BDLY_SRC_getUnitDate($unidate);
        echo json_encode($data)  ;
    }
    public function BDLY_SRC_UpdaterowData(){
        ...
        $selectedSearchopt=$this->input->post('selectedSearchopt');        
        $data=$this->Mdl_biz_expense_daily_entry_search_update_delete->BDLY_SRC_UpdaterowData($BDLY_DT_row_new_vals,$BDLY_DT_row_old_vals,$BDLY_SRC_lb_ExpenseList,$selectedSearchopt,$USERSTAMP);
        echo ($data)  ;
    }
    public function BDLY_SRC_DeleteRowData(){
        ...
        $selectedexpense=$this->input->post('selectedexpense');        
        $data=$this->Mdl_biz_expense_daily_entry_search_update_delete->BDLY_SRC_DeleteRowData($BDLY_SRC_DeleteKey,$selectedexpense,$USERSTAMP);
        echo ($data)  ;
    }
}