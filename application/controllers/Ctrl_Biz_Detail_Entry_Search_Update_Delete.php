...
// initial form
    ...
    {
        $this->load->view('EXPENSE/BIZ EXPENSE/Vw_Biz_Detail_Entry_Search_Update_Delete');
    }
    public function BDTL_INPUT_expense_err_invoice(){
        $this->load->model('EXPENSE/BIZ EXPENSE/Mdl_biz_detail_entry_search_update_delete');
