...
$USERSTAMP=$UserStamp;
class Expense_personal_daily_entry_search_update_delete_controller extends CI_Controller{
// initial form
    public function index()
    {
        $this->load->view('Expense_personal_daily_entry_search_update_delete_view.php');
    }
    // fetch data
    public function commondata()
    {
        ...
        $this->load->model('Expense_personal_daily_entry_search_update_delete_model');
        $data=$this->Expense_personal_daily_entry_search_update_delete_model->common_data($ErrorMessage);
    ...
    public function PDLY_SEARCH_lb_babysearchoptionvalue()
    {
        ...
        $this->load->model('Expense_personal_daily_entry_search_update_delete_model');
        $data=$this->Expense_personal_daily_entry_search_update_delete_model->PDLY_SEARCH_lb_babysearchoptionvalue($categorydata);
        echo json_encode($data);
    }
    ...
    public function PDLY_SEARCH_lb_comments()
    {
        ...
        $this->load->model('Expense_personal_daily_entry_search_update_delete_model');
        $data=$this->Expense_personal_daily_entry_search_update_delete_model->PDLY_SEARCH_lb_comments($PDLY_SEARCH_lb_typelistvalue,$PDLY_SEARCH_lb_getstartvaluevalue,$PDLY_SEARCH_lb_getendvaluevalue);
        echo json_encode($data);
    }
    ...
    public function PDLY_SEARCH_lb_invoicefrom()
    {
        ...
        $PDLY_SEARCH_lb_getendvaluevalue=date('Y-m-d',strtotime($PDLY_SEARCH_lb_getendvaluevalue));
        $this->load->model('Expense_personal_daily_entry_search_update_delete_model');
        $data=$this->Expense_personal_daily_entry_search_update_delete_model->PDLY_SEARCH_lb_invoicefrom($PDLY_SEARCH_lb_typelistvalue,$PDLY_SEARCH_lb_getstartvaluevalue,$PDLY_SEARCH_lb_getendvaluevalue,$PDLY_SEARCH_lb_babysearchoptionvalue);
        echo json_encode($data);
    }
    ...
    public function PDLY_SEARCH_lb_invoiceitems()
    {
        ...
        $PDLY_SEARCH_lb_getendvaluevalue=date('Y-m-d',strtotime($PDLY_SEARCH_lb_getendvaluevalue));
        $this->load->model('Expense_personal_daily_entry_search_update_delete_model');
        $data=$this->Expense_personal_daily_entry_search_update_delete_model->PDLY_SEARCH_lb_invoiceitems($PDLY_SEARCH_lb_typelistvalue,$PDLY_SEARCH_lb_getstartvaluevalue,$PDLY_SEARCH_lb_getendvaluevalue,$PDLY_SEARCH_lb_babysearchoptionvalue);
        echo json_encode($data);
    }
    ...
    public function PDLY_SEARCH_searchbybaby()
    {
        ...
        $this->load->model('Expense_personal_daily_entry_search_update_delete_model');
        $data=$this->Expense_personal_daily_entry_search_update_delete_model->PDLY_SEARCH_searchbybaby($PDLY_SEARCH_typelistvalue,$PDLY_SEARCH_startdate,$PDLY_SEARCH_enddate,$PDLY_SEARCH_babysearchoption,$PDLY_SEARCH_fromamount,$PDLY_SEARCH_toamount,$PDLY_SEARCH_searchcomments,$PDLY_SEARCH_invitemcom,$PDLY_SEARCH_invfromcomt,$PDLY_SEARCH_babycategory);
    ...
    public function expensebabyupdate(){
        ...
        $this->load->model('Expense_personal_daily_entry_search_update_delete_model');
        $result = $this->Expense_personal_daily_entry_search_update_delete_model->expensebabyupdate($ebid,$babycategory,$babyinvdate,$babyinamt,$babyinfromt,$babyinvitem,$babycomment,$USERSTAMP) ;
        if ($result == TRUE) {
            $flag=1;
        } else {
            $flag=0;
    ...
    public function expensecarupdate(){
        ...
        $this->load->model('Expense_personal_daily_entry_search_update_delete_model');
        $result = $this->Expense_personal_daily_entry_search_update_delete_model->expensecarupdate($ecid,$carcategory,$carinvdate,$carinamt,$carinfromt,$carinvitem,$carcomment,$USERSTAMP) ;
    ...
    public function expensepersonalupdate(){
        ...
        $this->load->model('Expense_personal_daily_entry_search_update_delete_model');
        $result = $this->Expense_personal_daily_entry_search_update_delete_model->expensepersonalupdate($epid,$personalcategory,$personalinvdate,$personalinamt,$personalinfromt,$personalinvitem,$personalcomment,$USERSTAMP) ;
        if ($result == TRUE) {
            $flag=1;
        } else {
            $flag=0;
    ...
    public function expensecarloanupdate(){
        ...
        $this->load->model('Expense_personal_daily_entry_search_update_delete_model');
        $result = $this->Expense_personal_daily_entry_search_update_delete_model->expensecarloanupdate($eclid,$eclpaiddate,$eclfromperiod,$ecltopaid,$eclamount,$eclcomments,$USERSTAMP) ;
        if ($result == TRUE) {
            $flag=1;
        } else {
            $flag=0;
  ...
  //DELETE OPTION
    public function deleteoption(){
        ...
        $PDLY_SEARCH_lb_babysearchoptionvalue= $this->input->post('PDLY_SEARCH_lb_babysearchoptionvalue');
        $this->load->model('Expense_personal_daily_entry_search_update_delete_model');
        $result = $this->Expense_personal_daily_entry_search_update_delete_model->deleteoption($PDLY_rowid,$startdate,$enddate,$PDLY_SEARCH_lb_typelistvalue,$PDLY_SEARCH_lb_babysearchoptionvalue,$USERSTAMP) ;
